...
const BookSection: FC<BookSectionProps> = ({ books, title, params: { locale } }) => {
  ...
  return (
    <Grid
      ...
      columnGap={9}
    >
      <GridItem pl="2" rowSpan={1} colSpan={{ base: 1, sm: 2, md: 9, lg: 12 }}>
      ...
      <GridItem colSpan={{ base: 1, sm: 2, md: 9, lg: 12 }} justifySelf="end">
        <Link as={NextLink} href={`/${locale}/books/${section.enum}`}>
          <Button variant="link" color="accent.orange" rightIcon={<ArrowForwardIcon />}>
            {t('bookCard.more')}
          </Button>
        </Link>
      </GridItem>
